...
//advanced - пользователь сам определяет тулбар
    ...
    public function run()
    {
		...
		$ckfinderAssets = Yii::app()->getAssetManager()->publish(realpath($baseDir . '/../ckfinder/assets'));
        ...
        $cs->registerScriptFile($ckfinderAssets.'/ckfinder.js');
...
CKFinder.setupCKEditor(editor, '{$ckfinderAssets}/');
EOP;
